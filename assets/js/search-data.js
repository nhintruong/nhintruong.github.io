...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/~nntruong/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/~nntruong/publications/";
          },
        },{id: "nav-projects",
          title: "Projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/~nntruong/projects/";
          },
        },{id: "nav-resume",
          title: "Resume",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/~nntruong/resume/";
          },
          ...
          section: "Projects",handler: () => {
              window.location.href = "/~nntruong/projects/3_gsoc_animint2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/~nntruong/projects/4_educational_chatbot/";
            },},{id: "projects-depause",
          title: 'DePause',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/~nntruong/projects/5_depause/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/~nntruong/assets/pdf/nhintruong_resume.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/~nntruong/feed.xml", "_blank");
        },
      },{
      id: 'light-theme',
